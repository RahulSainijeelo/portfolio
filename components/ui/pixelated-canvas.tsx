...
type PixelatedCanvasProps = {
  ...
  /** Horizontal alignment of the image within the canvas (for contain/fill/none). */
  ...
  React.useEffect(() => {
    ...
    const compute = () => {
      ...
      if (objectFit === "cover") {
        ...
        if (horizontalAlign === "left") dx = 0;
        else if (horizontalAlign === "right") dx = displayWidth - dw;
        else dx = Math.floor((displayWidth - dw) / 2);
